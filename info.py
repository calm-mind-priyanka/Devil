...
OWNER_USERNAME = environ.get('OWNER_USERNAME', 'Sandymaiwait') # without @ or https://t.me/ 
...
AUTH_REQ_CHANNEL = int(environ.get('AUTH_REQ_CHANNEL', '-1002260068200'))
...
request_channel = environ.get('REQUEST_CHANNEL', '-1002359536802') 
REQUEST_CHANNEL = int(request_channel) if request_channel and id_pattern.search(request_channel) else None
MOVIE_UPDATE_CHANNEL = int(environ.get('MOVIE_UPDATE_CHANNEL', '-1002260068200')) 

# Added Link Here Not Id 
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'https://t.me/+4pPWKtxin2YyNTc1')
...
SHORTENER_API2 = environ.get("SHORTENER_API2", "7668446fc2e9a5f76f79b7741ae5ea231c8611d0")
SHORTENER_WEBSITE2 = environ.get("SHORTENER_WEBSITE2", 'Mdiskshort.in')
SHORTENER_API3 = environ.get("SHORTENER_API3", "7668446fc2e9a5f76f79b7741ae5ea231c8611d0")
...
START_IMG = (environ.get('START_IMG', 'https://graph.org/file/37024d8bf09ee86288180-2687fda43ba35ba2ec.jpg')).split()
FORCESUB_IMG = environ.get('FORCESUB_IMG', 'https://graph.org/file/e6c8c517ee3f42d5d772e-331533c6320d361b70.jpg')
REFER_PICS = (environ.get("REFER_PICS", "https://envs.sh/PSI.jpg")).split() 
PAYPICS = (environ.get('PAYPICS', 'https://graph.org/file/5635f6bd5f76da19ccc70-695af75bfa01aacbf2.jpg')).split()
